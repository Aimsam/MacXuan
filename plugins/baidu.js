    ...
    var baidupan = (function() {
        ...
        return {
            ...
            set_export_ui: function() {
                ...
                var aria2_export = $("<a>").text("麦旋风下载").appendTo(list);
                var aria2_download = $("<a style='display:none;'>").text("导出下载").attr("id", "aria2_download").appendTo(list);
                var config = $("<a style='display:none;'>").text("设置").appendTo(list);
                if (!home) {
...
onload(function() {
    ...
    //    if (response) {
            ...
            script.appendChild(document.createTextNode('(' + baidu + ')(\'' + combine_cookies + '\');'));
